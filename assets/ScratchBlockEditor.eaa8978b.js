...
. . .
. . .
. . .`}},data(){return{script:this.initialScript,style:"scratch3",language:"en",fromLanguage:"en",toLanguage:"en",svgData:null,pngData:null}},methods:{updateScript(e){this.script=e,this.$emit("update:script",this.script)},updateStyle(e){this.style=e},updateLanguage(e){this.fromLanguage=this.toLanguage,this.language=e,this.toLanguage=e,this.updateTranslatedScript()},updateTranslatedScript(){if(this.script&&this.$scratchblocks.allLanguages.hasOwnProperty(this.toLanguage)){const e=this.$scratchblocks.parse(this.script,{languages:[this.fromLanguage,this.toLanguage]});e.translate(this.$scratchblocks.allLanguages[this.toLanguage]),this.script=e.stringify()}},handleRendered(e,s){console.log(s),this.svgData=e,this.pngData=s}},mounted(){}},Z={class:"row q-pb-sm"},A={class:"col-3 q-px-xs"},F={class:"col-3 q-px-xs"},J={class:"col-6 q-px-xs"},K={class:"row q-pb-sm"},ee={class:"col-6 q-px-xs"},te={class:"col-6 q-px-xs"};function oe(e,s,o,a,t,n){const r=h("StyleSelector"),l=h("LanguageSelector"),i=h("ExportButtons"),v=h("CodeEditor"),m=h("BlockRenderer");return c(),p(L,{padding:""},{default:S(()=>[d("div",Z,[d("div",A,[u(r,{value:t.style,onInput:n.updateStyle},null,8,["value","onInput"])]),d("div",F,[u(l,{value:t.language,onInput:n.updateLanguage},null,8,["value","onInput"])]),d("div",J,[u(i,{svgData:t.svgData,pngData:t.pngData},null,8,["svgData","pngData"])])]),d("div",K,[d("div",ee,[u(v,{value:t.script,onInput:n.updateScript},null,8,["value","onInput"])]),d("div",te,[u(m,{script:t.script,"from-lang":t.fromLanguage,"to-lang":t.toLanguage,style:D(t.style),onRendered:n.handleRendered},null,8,["script","from-lang","to-lang","style","onRendered"])])])]),_:1})}var pe=g(Y,[["render",oe]]);export{pe as default};
